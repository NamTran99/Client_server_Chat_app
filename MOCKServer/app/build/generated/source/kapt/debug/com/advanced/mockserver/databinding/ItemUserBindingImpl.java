...
public class ItemUserBindingImpl extends ItemUserBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.frame_contact, 2);
        sViewsWithIds.put(R.id.image_contact, 3);
        sViewsWithIds.put(R.id.frame_search, 4);
        sViewsWithIds.put(R.id.image_search, 5);
    }
    // views
    @NonNull
    ...
    private ItemUserBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.textNameContact.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            setUser((com.advanced.mockserver.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.advanced.mockserver.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.advanced.mockserver.User user = mUser;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textNameContact, userName);
        }
    }
